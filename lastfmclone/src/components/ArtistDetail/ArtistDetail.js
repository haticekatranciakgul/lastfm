...
function ArtistDetail({ darkMode }) {
  ...
  useEffect(() => {
    const albumData = async () => {
      ...
      await axios
        .get(
          `https://ws.audioscrobbler.com/2.0/?method=artist.gettopalbums&artist=${params.name}&api_key=ad2ed55339a95101cce12a6d7efa32f4&format=json&limit=999`
        )
        .then((response) => {
    ...
    const trackData = async () => {
      ...
      await axios
        .get(
          `https://ws.audioscrobbler.com/2.0/?method=artist.gettoptracks&artist=${params.name}&api_key=ad2ed55339a95101cce12a6d7efa32f4&format=json&limit=999`
        )
        .then((response) => {
